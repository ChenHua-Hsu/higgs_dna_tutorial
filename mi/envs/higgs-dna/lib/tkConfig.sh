...
# installed.
TK_PREFIX='/eos/home-c/chenhua/higgsdna_finalfits_tutorial_24/micromamba_dir/envs/higgs-dna'

# Top-level directory in which Tk's platform-specific files (e.g.
# executables) are installed.
TK_EXEC_PREFIX='/eos/home-c/chenhua/higgsdna_finalfits_tutorial_24/micromamba_dir/envs/higgs-dna'
...
# build directory.
TK_BUILD_LIB_SPEC='-L/eos/home-c/chenhua/higgsdna_finalfits_tutorial_24/micromamba_dir/envs/higgs-dna/lib -ltk8.6'

# String to pass to linker to pick up the Tk library from its
# installed directory.
TK_LIB_SPEC='-L/eos/home-c/chenhua/higgsdna_finalfits_tutorial_24/micromamba_dir/envs/higgs-dna/lib -ltk8.6'

# String to pass to the compiler so that an extension can
# find installed Tk headers.
TK_INCLUDE_SPEC='-I/eos/home-c/chenhua/higgsdna_finalfits_tutorial_24/micromamba_dir/envs/higgs-dna/include'
...
# compiled.
TK_SRC_DIR='/eos/home-c/chenhua/higgsdna_finalfits_tutorial_24/micromamba_dir/envs/higgs-dna/include'
...
# build directory.
TK_BUILD_STUB_LIB_SPEC='-L/eos/home-c/chenhua/higgsdna_finalfits_tutorial_24/micromamba_dir/envs/higgs-dna/lib -ltkstub8.6'

# String to pass to linker to pick up the Tk stub library from its
# installed directory.
TK_STUB_LIB_SPEC='-L/eos/home-c/chenhua/higgsdna_finalfits_tutorial_24/micromamba_dir/envs/higgs-dna/lib -ltkstub8.6'

# Path to the Tk stub library in the build directory.
TK_BUILD_STUB_LIB_PATH='/eos/home-c/chenhua/higgsdna_finalfits_tutorial_24/micromamba_dir/envs/higgs-dna/lib/libtkstub8.6.a'

# Path to the Tk stub library in the install directory.
TK_STUB_LIB_PATH='/eos/home-c/chenhua/higgsdna_finalfits_tutorial_24/micromamba_dir/envs/higgs-dna/lib/libtkstub8.6.a'
