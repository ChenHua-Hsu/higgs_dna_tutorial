...
def load_mc_samples(processes, base_path):
    ...
    for process in processes:
        MC_dict[f'{process}_arr'] = load_data(f'{base_path}/{process}_M-125_preEE/nominal')
    return MC_dict
...
def plot_variable(data_hist, data_edges, mc_hist, mc_edges, config, var_config, plots_dir):
