...
def main(config_file, input_dir, output_dir):
    ...
    for process in processes:
        weight = np.asarray(MC_dict[f'{process}_arr'].weight) * cross_sections[process]
    ...
    for var_config in config['variables']:
        ...
        # Plot the variable
        plot_variable(data_hist, data_edges, mc_var_hist, mc_var_edges, config, var_config, output_dir)
