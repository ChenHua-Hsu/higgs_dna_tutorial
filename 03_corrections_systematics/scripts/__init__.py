...
import logging
# ! new
from .Tutorial_Weight_Syst import Tutorial_Weight
...
object_systematics = {
    ...
    "Tutorial_corr": {
        ...
        "args": {
            "kind": "UpDownSystematic",
            "what": "pt",
            "varying_function": partial(Tutorial_Weight, is_correction=False),
        },
    },
}
...
object_corrections = {
    ...
    # ! new
    "Tutorial_corr": partial(Tutorial_Weight, pt=None, is_correction=True),
}
